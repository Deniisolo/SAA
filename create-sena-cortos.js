...
/**
 * Script para crear programas específicos del SENA con nombres cortos
 */
...
async function createSenaCortos() {
  try {
    console.log('🎓 Creando programas SENA con nombres cortos...')
    
    await prisma.$connect()
    console.log('✅ Conexión establecida')
    
    // Programas específicos del SENA con nombres cortos (máximo 45 caracteres)
    const programasSena = [
      // Técnicos SENA
